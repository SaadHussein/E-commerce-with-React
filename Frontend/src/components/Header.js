    ...
    <div className="w-full h-20 border-b-[1px] border-b-gray-800 font-titleFont sticky top-0 z-50 bg-white">
      <div className="flex items-center justify-between max-w-screen-xl h-full mx-4 xl:mx-auto">
        ...
        <div className="flex items-center mobile:gap-8 gap-4 relative">
          ...
          <Link to="/login">
            <img
              src={
                userInfo
                  ? userInfo.image
                  : "https://images.unsplash.com/photo-1690934872924-4deafe751039?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1887&q=80"
              }
              alt="Logo Image"
          ...
          {userInfo && (
            <p className="text-base font-titleFont font-semibold underline underline-offset-2 midLarge:block hidden">
              {userInfo.name}
            </p>
          )}
